let keyPairFromPriv;_142‍.x([["default",()=>Transaction]]);_142‍.w("./wallet",[["keyPairFromPriv",["keyPairFromPriv"],function(v){keyPairFromPriv=v}]]);
...
// (*** simplified for now, add extra params later ***)
    ...
    signTransaction(privateKey, scrtMsg) {
        ...
        _142‍.g.console.log("Is this a valid signature?   " + isValid) 
    ...
    isValid() {
        ...
        _142‍.g.console.log("Recovered pubKey:", pubKeyRecovered.encodeCompressed("hex"));

        var isValid = ec.verify(this.scrtMsg, this.signature, pubKeyRecovered);
        _142‍.g.console.log("Is this a valid signature from isValid() ?   " + isValid) //true
    }
}