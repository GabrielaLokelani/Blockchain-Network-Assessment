let BlockChain,Transaction,createWallet,validateWallet;_220‍.w("./src/chain",[["default",["BlockChain"],function(v){BlockChain=v}]]);_220‍.w("./src/transaction",[["default",["Transaction"],function(v){Transaction=v}]]);_220‍.w("./src/wallet",[["createWallet",["createWallet"],function(v){createWallet=v}],["validateWallet",["validateWallet"],function(v){validateWallet=v}]]);
...
_220‍.g.console.log("is myWallet privateKey equal to publicKey?", validateWallet(myWallet.privateKey, myWallet.publicKey));
...
_220‍.g.console.log("Balance of Jake's account is: ", MIEWCOIN_BLOCKCHAIN.getBalanceOfAddress(jakeWallet.publicKey));

// Test blockchain validation
_220‍.g.console.log("is the chain valid? " + MIEWCOIN_BLOCKCHAIN.isChainValid());
_220‍.g.console.log("is the chain valid 2? " + MIEWCOIN_BLOCKCHAIN.isValidChain());
...
_220‍.g.console.log("is the chain still valid? " + MIEWCOIN_BLOCKCHAIN.isValidChain());

// We print the whole blockchain
_220‍.g.console.log(JSON.stringify(MIEWCOIN_BLOCKCHAIN, null, 5));
