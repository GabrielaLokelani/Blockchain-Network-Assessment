...
'use strict';;let BlockChain,Transaction,createWallet,validateWallet;_b47‍.w("./src/chain",[["default",["BlockChain"],function(v){BlockChain=v}]]);_b47‍.w("./src/transaction",[["default",["Transaction"],function(v){Transaction=v}]]);_b47‍.w("./src/wallet",[["createWallet",["createWallet"],function(v){createWallet=v}],["validateWallet",["validateWallet"],function(v){validateWallet=v}]]);
...
_b47‍.g.console.log("is myWallet privateKey equal to publicKey?", validateWallet(myWallet.privateKey, myWallet.publicKey));
...
_b47‍.g.console.log("Balance of Jake's account is: ", MIEWCOIN_BLOCKCHAIN.getBalanceOfAddress(jakeWallet.publicKey));

// Test blockchain validation
_b47‍.g.console.log("is the chain valid? " + MIEWCOIN_BLOCKCHAIN.isChainValid());
_b47‍.g.console.log("is the chain valid 2? " + MIEWCOIN_BLOCKCHAIN.isValidChain());
...
_b47‍.g.console.log("is the chain still valid? " + MIEWCOIN_BLOCKCHAIN.isValidChain());

let chain = JSON.stringify(MIEWCOIN_BLOCKCHAIN, null, 5);

_b47‍.g.console.log('testing return chain: ' + chain);
