let keyPairFromPriv;_6a2‍.x([["default",()=>Transaction]]);_6a2‍.w("./wallet",[["keyPairFromPriv",["keyPairFromPriv"],function(v){keyPairFromPriv=v}]]);
...
// (*** simplified for now, add extra params later ***)
    ...
    signTransaction(privateKey) {
        ...
        const signingKey = ec.keyPairFromPriv(privateKey);
        // JSON.stringify(signingKey);
        _6a2‍.g.console.log("sign txn here is the keypair from private: " + JSON.stringify(signingKey));
        ...
        _6a2‍.g.console.log("public key from signingkey: " + publicKey);
        ...
        _6a2‍.g.console.log('signature: ' + this.signature);
    }
