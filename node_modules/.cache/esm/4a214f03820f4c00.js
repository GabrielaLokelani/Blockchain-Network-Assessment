...
'use strict';;let BlockChain,initHttpServer,Transaction,createWallet,validateWallet;_820‍.w("./src/chain",[["default",["BlockChain"],function(v){BlockChain=v}]]);_820‍.w("./src/node",[["initHttpServer",["initHttpServer"],function(v){initHttpServer=v}]]);_820‍.w("./src/transaction",[["default",["Transaction"],function(v){Transaction=v}]]);_820‍.w("./src/wallet",[["createWallet",["createWallet"],function(v){createWallet=v}],["validateWallet",["validateWallet"],function(v){validateWallet=v}]]);
