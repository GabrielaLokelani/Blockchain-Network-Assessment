let keyPairFromPriv;_d3d‍.x([["default",()=>Transaction]]);_d3d‍.w("./wallet",[["keyPairFromPriv",["keyPairFromPriv"],function(v){keyPairFromPriv=v}]]);// IMPORT RELEVANT LIBRARIES
...
// create the transaction class which each new transaaction will follow
    ...
    signTransaction(privateKey, scrtMsg) {
        ...
        _d3d‍.g.console.log("Is this a valid signature?   " + isValid);
    ...
    isValid() {
        ...
        _d3d‍.g.console.log("Recovered pubKey:", pubKeyRecovered.encodeCompressed("hex"));
        ...
        _d3d‍.g.console.log("Is this a valid signature from isValid() ?   " + isValid); //true
    }
}
