let keyPairFromPriv;_74b‍.x([["default",()=>Transaction]]);_74b‍.w("./wallet",[["keyPairFromPriv",["keyPairFromPriv"],function(v){keyPairFromPriv=v}]]);// IMPORT RELEVANT LIBRARIES
...
// create the transaction class which each new transaaction will follow
    ...
    signTransaction(privateKey, scrtMsg) {
        ...
        _74b‍.g.console.log("Is this a valid signature?   " + isValid) 
    ...
    isValid() {
        ...
        _74b‍.g.console.log("Recovered pubKey:", pubKeyRecovered.encodeCompressed("hex"));

        var isValid = ec.verify(this.scrtMsg, this.signature, pubKeyRecovered);
        _74b‍.g.console.log("Is this a valid signature from isValid() ?   " + isValid) //true
    }
}