...
'use strict';;let BlockChain,connectToPeers,initP2PServer,initialPeers,initHttpServer,initFaucetServer;_a6b‍.x([["MIEWCOIN_BLOCKCHAIN",()=>MIEWCOIN_BLOCKCHAIN]]);_a6b‍.w("./src/chain",[["default",["BlockChain"],function(v){BlockChain=v}]]);_a6b‍.w("./src/node",[["connectToPeers",["connectToPeers"],function(v){connectToPeers=v}],["initP2PServer",["initP2PServer"],function(v){initP2PServer=v}],["initialPeers",["initialPeers"],function(v){initialPeers=v}]]);_a6b‍.w("./src/server",[["initHttpServer",["initHttpServer"],function(v){initHttpServer=v}]]);_a6b‍.w("./src/faucet",[["initFaucetServer",["initFaucetServer"],function(v){initFaucetServer=v}]]);
...
const bodyParser = require('body-parser');
       ...
       const MIEWCOIN_BLOCKCHAIN = new (_a6b‍.a("BlockChain",BlockChain))();;_a6b‍.j(["MIEWCOIN_BLOCKCHAIN"]);
_a6b‍.a("initHttpServer",initHttpServer)();
_a6b‍.a("connectToPeers",connectToPeers)(_a6b‍.a("initialPeers",initialPeers));
_a6b‍.a("initP2PServer",initP2PServer)();
// initFaucetServer();
