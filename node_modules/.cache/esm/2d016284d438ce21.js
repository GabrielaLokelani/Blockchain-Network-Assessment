let keyPairFromPriv;_d43‍.x([["default",()=>Transaction]]);_d43‍.w("./wallet",[["keyPairFromPriv",["keyPairFromPriv"],function(v){keyPairFromPriv=v}]]);// IMPORT RELEVANT LIBRARIES
...
// create the transaction class which each new transaaction will follow
    ...
    signTransaction(privateKey, scrtMsg) {
        ...
        _d43‍.g.console.log("Is this a valid signature?   " + isValid);
    ...
    isValid() {
        ...
        _d43‍.g.console.log("Recovered pubKey:", pubKeyRecovered.encodeCompressed("hex"));
        ...
        _d43‍.g.console.log("Is this a valid signature from isValid() ?   " + isValid); //true
    }
}