let keyPairFromPriv;_aad‍.x([["default",()=>Transaction]]);_aad‍.w("./wallet",[["keyPairFromPriv",["keyPairFromPriv"],function(v){keyPairFromPriv=v}]]);
...
// (*** simplified for now, add extra params later ***)
    ...
    signTransaction(privateKey, scrtMsg) {
        ...
        _aad‍.g.console.log('signature: ' + this.signature);
    }
