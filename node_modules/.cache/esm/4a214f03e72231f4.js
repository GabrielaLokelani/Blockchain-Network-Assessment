...
'use strict';;let BlockChain,initHttpServer,connectToPeers,initP2PServer,initialPeers,initFaucetServer;_e72‍.x([["MIEWCOIN_BLOCKCHAIN",()=>MIEWCOIN_BLOCKCHAIN]]);_e72‍.w("./src/chain",[["default",["BlockChain"],function(v){BlockChain=v}]]);_e72‍.w("./src/node",[["initHttpServer",["initHttpServer"],function(v){initHttpServer=v}],["connectToPeers",["connectToPeers"],function(v){connectToPeers=v}],["initP2PServer",["initP2PServer"],function(v){initP2PServer=v}],["initialPeers",["initialPeers"],function(v){initialPeers=v}]]);_e72‍.w("./src/faucet",[["initFaucetServer",["initFaucetServer"],function(v){initFaucetServer=v}]]);
...
const bodyParser = require('body-parser');
       ...
       const MIEWCOIN_BLOCKCHAIN = new (_e72‍.a("BlockChain",BlockChain))();;_e72‍.j(["MIEWCOIN_BLOCKCHAIN"]);
_e72‍.a("initHttpServer",initHttpServer)();
_e72‍.a("connectToPeers",connectToPeers)(_e72‍.a("initialPeers",initialPeers));
_e72‍.a("initP2PServer",initP2PServer)();
// initFaucetServer();
